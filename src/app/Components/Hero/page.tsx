...
export default function Hero() {
  ...
  const texts = [
    ...
    'Would you like to explore our AI Integration Solution?',
  ...
  return (
    <div className="bg-black">
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-black via-black to-[#12001b]">
        <div className="text-[#12001b] rounded-2xl text-sm h-[35px] w-[250px] text-center py-2 text-purple-500 bg-slate-800/90">
        ...
        <div className="flex w-[700px] h-[100px] rounded-xl bg-white/5 border-2 border-purple-700 mb-6 pt-4 ">
          <div className="text-white text-[30px] w-[40px] h-[40px] rounded-3xl bg-gradient-to-r from-blue-600 to-purple-600 ml-5 mt-2">
            <RiRobot2Line className="pt-2 pl-2" />
          </div>
